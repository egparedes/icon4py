...
def assemble_driver_states(
    *,
    ...
    prognostic_state_next = prognostics.PrognosticState(
        vn=data_alloc.to_allocator(prognostic_state_now.vn, allocator=allocator),
        w=data_alloc.to_allocator(prognostic_state_now.w, allocator=allocator),
        exner=data_alloc.to_allocator(prognostic_state_now.exner, allocator=allocator),
        rho=data_alloc.to_allocator(prognostic_state_now.rho, allocator=allocator),
        theta_v=data_alloc.to_allocator(prognostic_state_now.theta_v, allocator=allocator),
    )
